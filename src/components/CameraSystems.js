            ...
            onMouseLeave={e => {
              ...
              <div className={Style.boxone}>
                ...
                <div className="w-52 h-64 border-solid border-2 border-slate-300">
                   ...
                   <div className="font-extrabold w-46 px-3 text-center flex items-center h-32 test-dark">VIEW ALL CAMERA SYSTEMS</div>
                </div>
                </a>
                <a href="">
                <div className="w-52 h-64 border-solid border-2 border-slate-300">
                   <img src={secutwo} className="w-52 h-32"/>
                    <div className={Style.numbox}>1</div>
                   <div className="font-extrabold w-46 pl-8 text-center flex items-center h-14 test-dark">CAMERA SYSTEMS</div>
                </div>
                </a>
                <a href="">
                <div className="w-52 h-64 border-solid border-2 border-slate-300">
                ...
                <div className="w-52 h-64 border-solid border-2 border-slate-300">
                   ...
                   <div className={Style.numbox}>3</div>
                   <div className="font-extrabold w-46 pl-8 text-center flex items-center h-14 test-dark">CAMERA SYSTEMS</div>
                </div>
                </a>
                <a href="">
